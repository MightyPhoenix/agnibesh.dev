                ...
                <div className={"section row"}>
                    ...
                    <div className={"col s12 m4"} style={{marginBottom:"10px",marginTop:"10px"}}>
                        <div className={"white"} style={{magin:"0px",padding:"10px", borderRadius:"8px",backgroundImage: "linear-gradient(60deg, #3d3393 0%, #2b76b9 37%, #2cacd1 65%, #35eb93 100%)"}}>
                            <IconContext.Provider  value={{size:"2rem",color:"white",style:{margin:"0 8px"}}}>
                        <h3 className={"font-neucha white-text"}>Basically my digital footprint<GiFootprint/></h3>
                            ...
                            <ul className="collection white-text font-neucha left-align" style={{border:"0px solid white",background:"rgba(0,0,0,0)",fontSize:"1.5rem"}}>
                                ...
                                <li className="collection-item avatar" style={{border:"0px solid white",background:"rgba(0,0,0,0)"}}>
                                    ...
                                    <p style={{marginTop:"5%"}}><a className={"white-text"} href={"https://www.linkedin.com/in/mightyphoenix7/"}>Industry norm</a></p>
                                </li>
                                ...
                                <li className="collection-item avatar" style={{border:"0px solid white",background:"rgba(0,0,0,0)"}}>
                                    ...
                                    <p style={{marginTop:"5%"}}><a className={"white-text"} href={"https://www.instagram.com/hsebinga"}>The Gram'</a></p>
                                </li>
                        ...
                        <h3 className={"font-caveat white-text"}>Trace me here...</h3>
                            <div className="mapouter center-align" style={{margin:"auto"}}>
                                <div className="gmap_canvas">
                                    <iframe style={{borderRadius:"8px"}} width="320" height="320" id="gmap_canvas" src="https://maps.google.com/maps?q=Kolkata&t=&z=11&ie=UTF8&iwloc=&output=embed" frameBorder="0" scrolling="no" marginHeight="0" marginWidth="0"></iframe>
                                </div>
                                    <style>{`
                                .mapouter{
                                text-align:center;
