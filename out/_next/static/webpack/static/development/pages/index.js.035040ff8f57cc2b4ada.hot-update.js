...
var index = function index() {
  ...
  return __jsx("div", {
    ...
    className: "jumbotron mt-4 gradhot text-white",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 26,
    ...
    className: "col-md-8 col-sm-12 justify-content-center align-self-center text-center",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 31,
  ...
  }, " Computer Enthusiast | JavaScript Ninja "), __jsx("blockquote", {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 34,
  ...
  }, "I grew up thinking computers were magical, and here I am making magic happen. I always like to create what I like for instance music, graphics, applications, videos and the Technology has provided me with the parallel applications to achieve that in my home computer i.e FL Studio, Photoshop, Adobe Premier Pro"), __jsx("p", {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 35,
  ...
  }, "Didn't like much computer games but started with habbo.com but as usual made a clone of that game too! But later on started an affection for FPS games."))))), __jsx(_src_Footer_Footer__WEBPACK_IMPORTED_MODULE_3__["default"], {
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 40,
...
//# sourceMappingURL=index.js.035040ff8f57cc2b4ada.hot-update.js.map