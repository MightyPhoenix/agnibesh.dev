  ...
  return (
    <div className="row container valign-wrapper center jumbo">
      ...
      <div className="col l8 center white-text">
        ...
        <h4 className="h4 font-neucha">
          {" "}
          {BioData.tagLine[0]} <br className={"hide-on-med-and-up"} />{" "}
          <span className="hide-on-small-and-down"> | </span>{" "}
          {BioData.tagLine[1]}{" "}
        </h4>
        <h5 className="font-caveat" style={{ fontSize: "26px" }}>
          B.Tech (CSE) 3ʳᵈ Year
        </h5>
        {BioData.paragraphs.map((para) => {
          return <p className="flow-text font-neucha ">{para}</p>;
        })}
        ...
        >
          Currently Working at Newslaundry! and a few Projects on React.
        </blockquote>
        ...
        >
          Head{" "}
          <a className="teal-text text-accent-1" href="/about">
            here
          </a>{" "}
          for more!
        </blockquote>
